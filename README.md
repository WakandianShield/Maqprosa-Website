...
├── us.html             # Sobre nosotros
├── services.html       # Servicios
├── equipment.html      # Equipo industrial
├── contact.html        # Contacto
├── README.md
└── frontend/
    ├── styles.css          # Estilos principales
    ├── styles_mobile.css   # Estilos responsive
    ├── script.js           # JavaScript principal
    ├── script_navbar.js    # Navegación
    ├── [página].css        # Estilos específicos por página
    ├── [página]_mobile.css # Estilos responsive por página
    └── media/
...
Desarrollado con ❤️ para MAQPROSA
